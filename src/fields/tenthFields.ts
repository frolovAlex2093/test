...
export const blocks10 = [
  ...
  },
  {
    ...
    blocksItem: [
      {
        blockName: 'Изготовитель и его адрес',
        id: 61,
        blockItem: [
          {
            name: 'Страна регистрации хозяйствующего субъекта',
            type: 'Autocomplete',
            id: 206,
            require: false,
            checkbox: false,
          ...
          {
            name: 'Полное наименование хозяйствующего субъекта',
            type: 'TextField',
            id: 207,
            require: true,
            checkbox: false,
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [209, 210, 211, 212, 213, 214, 215, 216, 217, 218],
            buttonText: 'Добавить юридический адрес',
            mainHidden: [true]
            // pattern: '^.{0,300}$',
            // error: false
          },
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [219, 220, 221, 222, 223, 224, 225, 226, 227, 228],
            buttonText: 'Добавить фактический адрес',
            mainHidden: [true]
            // pattern: '^.{0,300}$',
            // error: false
          },
          ...
          },
          {
            ...
            hiddenButton: [
              ...
              223, 224, 225, 226, 227, 228, 229, 230, 293, 231
            ],
            mainHidden: [true],
            buttonText: 'Добавить'
            // pattern: '^.{0,20}$',
      ...
      {
        blockName: 'Сборочный завод и его адрес',
        id: 62,
        blockItem: [
          {
            name: 'Страна регистрации хозяйствующего субъекта',
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [235, 236, 237, 238, 239, 240, 241, 242, 243, 244],
            buttonText: 'Добавить юридический адрес',
            mainHidden: [true]
            // pattern: '^.{0,300}$',
            // error: false
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [245, 246, 247, 248, 249, 250, 251, 252, 253, 254],
            buttonText: 'Добавить фактический адрес',
            mainHidden: [true]
            // pattern: '^.{0,300}$',
            // error: false
          ...
          },
          {
            ...
            hiddenButton: [
              ...
              249, 250, 251, 252, 253, 254, 255, 256, 294, 257
            ],
            mainHidden: [true],
            buttonText: 'Добавить'
            // pattern: '^.{0,20}$',
      ...
      {
        blockName: 'Представитель изготовителя и его адрес',
        id: 63,
        blockItem: [
          {
            name: 'Страна регистрации хозяйствующего субъекта',
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [261, 262, 263, 264, 265, 266, 267, 268, 269, 270],
            buttonText: 'Добавить юридический адрес',
            mainHidden: [true]
            // pattern: '^.{0,300}$',
            // error: false
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [280, 281, 282, 283, 284, 285, 286, 287, 288, 289],
            buttonText: 'Добавить фактический адрес',
            mainHidden: [true]
            // pattern: '^.{0,300}$',
            // error: false
          ...
          },
          {
            ...
            hidden: true,
            hiddenButton: [
              258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 280, 281, 282, 283,
              284, 285, 286, 287, 288, 289, 290, 291, 295, 292
            ],
            mainHidden: [true],
            buttonText: 'Добавить'
            // pattern: '^.{0,20}$',
