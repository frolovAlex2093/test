...
export const eleventhFields = [
  ...
  },
  {
    ...
    blocksItem: [
      ...
      {
        blockName: 'Документ об оценке соответствия',
        id: 43,
        blockItem: [
          {
  ...
  {
    blocksName: 'Сведения о собственнике',
    id: 7,
    blocksItem: [
      {
        blockName: '',
    ...
    blocksItem: [
      {
        ...
        blockItem: [
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [214, 215, 216, 217, 218, 219, 220, 221, 222, 223],
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [224, 225, 226, 227, 228, 229, 230, 231, 232, 233],
      ...
      },
      {
        ...
        blockItem: [
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [241, 242, 243, 244, 245, 246, 247, 248, 249, 250],
            buttonText: 'Добавить юридический адрес',
            mainHidden: [true]
            // pattern: '^.{0,300}$',
            // error: false
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [251, 252, 253, 254, 255, 256, 257, 258, 259, 260],
            buttonText: 'Добавить фактический адрес',
            mainHidden: [true]
            // pattern: '^.{0,300}$',
            // error: false
      ...
      },
      {
        ...
        blockItem: [
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [268, 269, 270, 271, 272, 273, 274, 275, 276, 277],
            buttonText: 'Добавить юридический адрес',
            mainHidden: [true]
            // pattern: '^.{0,300}$',
            // error: false
          ...
          },
          {
            ...
            value: [''],
            hidden: true,
            hiddenButton: [278, 279, 280, 281, 282, 283, 284, 285, 286, 287],
            buttonText: 'Добавить фактический адрес',
            mainHidden: [true]
            // pattern: '^.{0,300}$',
            // error: false
