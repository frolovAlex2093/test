          ...
          <Box key={index} display='flex' flexDirection='column'>
            ...
            {item.error ? (
              ...
              <Alert variant='filled' severity='error' sx={{ marginBottom: '10px' }}>
                ...
                {item.pattern === '^3(643|112)01[0-9]{9}$'
                  ? 'Номер электронного паспорта не соответствует основанию оформления или указан некорректно'
                  : ''}
                {item.pattern === '^3(643|112)02[0-9]{9}$'
                  ? 'Номер электронного паспорта не соответствует основанию оформления или указан некорректно'
                  : ''}
                {item.pattern === '^3(643|112)03[0-9]{9}$'
                  ? 'Номер электронного паспорта не соответствует основанию оформления или указан некорректно'
                  : ''}
                ...
                {item.pattern === '^(RU|BY).+$' ? 'Некорректно указана мнемоника' : ''}
